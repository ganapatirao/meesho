...
public class SeedController : ControllerBase
{
    ...
    public async Task<ActionResult> SeedDatabase()
    {
        ...
        // Get the inserted subcategories with their IDs
        var insertedSubCategories = await _context.SubCategories.Find(_ => true).ToListAsync();
        ...
        if (insertedVendors.Count > 0 && insertedCompanies.Count > 0 && insertedCategories.Count > 0 && insertedSubCategories.Count > 0)
        {
            // Get category and subcategory IDs
            var fashionCategory = insertedCategories.FirstOrDefault(c => c.Name == "fashion");
            var fashionMensWear = insertedSubCategories.FirstOrDefault(sc => sc.Name == "mens-wear");
            var fashionWomensWear = insertedSubCategories.FirstOrDefault(sc => sc.Name == "womens-wear");
            
            var electronicsCategory = insertedCategories.FirstOrDefault(c => c.Name == "electronics");
            var electronicsMobiles = insertedSubCategories.FirstOrDefault(sc => sc.Name == "mobiles");
            var electronicsLaptops = insertedSubCategories.FirstOrDefault(sc => sc.Name == "laptops");
            var electronicsAudio = insertedSubCategories.FirstOrDefault(sc => sc.Name == "audio");
            var electronicsWearables = insertedSubCategories.FirstOrDefault(sc => sc.Name == "wearables");
            
            var homeCategory = insertedCategories.FirstOrDefault(c => c.Name == "home-living");
            var homeFurniture = insertedSubCategories.FirstOrDefault(sc => sc.Name == "furniture");
            var homeBedding = insertedSubCategories.FirstOrDefault(sc => sc.Name == "bedding");
            var homeDecor = insertedSubCategories.FirstOrDefault(sc => sc.Name == "decor");
            
            var beautyCategory = insertedCategories.FirstOrDefault(c => c.Name == "beauty");
            var beautyMakeup = insertedSubCategories.FirstOrDefault(sc => sc.Name == "makeup");
            var beautySkincare = insertedSubCategories.FirstOrDefault(sc => sc.Name == "skincare");
            var beautyHaircare = insertedSubCategories.FirstOrDefault(sc => sc.Name == "haircare");
            
            var sportsCategory = insertedCategories.FirstOrDefault(c => c.Name == "sports");
            var sportsFitness = insertedSubCategories.FirstOrDefault(sc => sc.Name == "fitness");
            
            var booksCategory = insertedCategories.FirstOrDefault(c => c.Name == "books");
            
            var jewelryCategory = insertedCategories.FirstOrDefault(c => c.Name == "jewelry");
            
            var footwearCategory = insertedCategories.FirstOrDefault(c => c.Name == "footwear");
            
            var kidsCategory = insertedCategories.FirstOrDefault(c => c.Name == "kids");
            
            var kitchenCategory = insertedCategories.FirstOrDefault(c => c.Name == "kitchen");
            
            var toysCategory = insertedCategories.FirstOrDefault(c => c.Name == "toys");
            
            var watchesCategory = insertedCategories.FirstOrDefault(c => c.Name == "watches");
            
            var bagsCategory = insertedCategories.FirstOrDefault(c => c.Name == "bags");
            
            var accessoriesCategory = insertedCategories.FirstOrDefault(c => c.Name == "accessories");

            // Fashion Products (10 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Men's Casual Shirt", Description = "Comfortable cotton shirt", Price = 599m, OriginalPrice = 999m, DiscountPercentage = 40, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionMensWear?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 1200, Stock = 500, SoldCount = 2500, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=500" }, Variants = new List<ProductVariant> { new ProductVariant { Id = Guid.NewGuid().ToString(), Color = "Blue", ColorCode = "#0000FF", Sizes = new List<string> { "S", "M", "L", "XL" }, Price = 599m, Stock = 125 }, new ProductVariant { Id = Guid.NewGuid().ToString(), Color = "White", ColorCode = "#FFFFFF", Sizes = new List<string> { "S", "M", "L" }, Price = 599m, Stock = 100 } } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Women's Dress", Description = "Elegant party dress", Price = 899m, OriginalPrice = 1499m, DiscountPercentage = 40, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionWomensWear?.Id ?? "", IsFeatured = true, IsTrending = false, Rating = 4.3m, ReviewCount = 890, Stock = 300, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=500" }, Variants = new List<ProductVariant> { new ProductVariant { Id = Guid.NewGuid().ToString(), Color = "Red", ColorCode = "#FF0000", Sizes = new List<string> { "S", "M", "L" }, Price = 899m, Stock = 100 }, new ProductVariant { Id = Guid.NewGuid().ToString(), Color = "Black", ColorCode = "#000000", Sizes = new List<string> { "S", "M", "L", "XL" }, Price = 899m, Stock = 150 } } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Men's T-Shirt", Description = "Premium cotton t-shirt", Price = 399m, OriginalPrice = 699m, DiscountPercentage = 43, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionMensWear?.Id ?? "", IsFeatured = false, IsTrending = true, Rating = 4.2m, ReviewCount = 560, Stock = 800, SoldCount = 3200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Women's Top", Description = "Stylish casual top", Price = 449m, OriginalPrice = 799m, DiscountPercentage = 44, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionWomensWear?.Id ?? "", IsFeatured = false, IsTrending = true, Rating = 4.1m, ReviewCount = 450, Stock = 600, SoldCount = 2800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Men's Jeans", Description = "Slim fit denim jeans", Price = 999m, OriginalPrice = 1599m, DiscountPercentage = 38, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionMensWear?.Id ?? "", IsFeatured = true, IsTrending = false, Rating = 4.4m, ReviewCount = 980, Stock = 400, SoldCount = 1900, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1542272604-787c3835535d?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Women's Jeans", Description = "High waist skinny jeans", Price = 899m, OriginalPrice = 1399m, DiscountPercentage = 36, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionWomensWear?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.3m, ReviewCount = 870, Stock = 350, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Men's Blazer", Description = "Formal blazer for men", Price = 1999m, OriginalPrice = 3499m, DiscountPercentage = 43, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionMensWear?.Id ?? "", IsFeatured = false, IsTrending = false, Rating = 4.5m, ReviewCount = 340, Stock = 150, SoldCount = 680, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Women's Kurti", Description = "Traditional ethnic wear", Price = 699m, OriginalPrice = 1199m, DiscountPercentage = 42, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionWomensWear?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 1200, Stock = 450, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Men's Polo", Description = "Classic polo t-shirt", Price = 549m, OriginalPrice = 899m, DiscountPercentage = 39, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionMensWear?.Id ?? "", IsFeatured = false, IsTrending = false, Rating = 4.2m, ReviewCount = 670, Stock = 550, SoldCount = 2300, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1625910513413-5fc45e60f2a2?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[0].Id ?? "", CompanyId = insertedCompanies[0].Id ?? "", Name = "Women's Saree", Description = "Designer silk saree", Price = 1499m, OriginalPrice = 2499m, DiscountPercentage = 40, CategoryId = fashionCategory?.Id ?? "", SubCategoryId = fashionWomensWear?.Id ?? "", IsFeatured = true, IsTrending = false, Rating = 4.6m, ReviewCount = 890, Stock = 200, SoldCount = 1200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=500" } }
            });

            // Electronics Products (8 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "Smartphone", Description = "Latest smartphone with 5G", Price = 15000m, OriginalPrice = 20000m, DiscountPercentage = 25, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsMobiles?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 2500, Stock = 200, SoldCount = 3500, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "Laptop", Description = "High performance laptop", Price = 45000m, OriginalPrice = 60000m, DiscountPercentage = 25, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsLaptops?.Id ?? "", IsFeatured = true, IsTrending = false, Rating = 4.4m, ReviewCount = 1800, Stock = 100, SoldCount = 2200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "Wireless Earbuds", Description = "Bluetooth earbuds with noise cancellation", Price = 1999m, OriginalPrice = 3499m, DiscountPercentage = 43, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsAudio?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.3m, ReviewCount = 3200, Stock = 500, SoldCount = 8900, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "Smart Watch", Description = "Fitness tracking smartwatch", Price = 2999m, OriginalPrice = 4999m, DiscountPercentage = 40, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsWearables?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 2800, Stock = 300, SoldCount = 5600, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "Bluetooth Speaker", Description = "Portable bluetooth speaker", Price = 1499m, OriginalPrice = 2499m, DiscountPercentage = 40, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsAudio?.Id ?? "", IsFeatured = false, IsTrending = true, Rating = 4.2m, ReviewCount = 1900, Stock = 400, SoldCount = 4200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "Power Bank", Description = "20000mAh power bank", Price = 999m, OriginalPrice = 1599m, DiscountPercentage = 38, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsAudio?.Id ?? "", IsFeatured = false, IsTrending = false, Rating = 4.1m, ReviewCount = 1500, Stock = 600, SoldCount = 3800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "USB Charger", Description = "Fast charging adapter", Price = 499m, OriginalPrice = 799m, DiscountPercentage = 38, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsAudio?.Id ?? "", IsFeatured = false, IsTrending = false, Rating = 4.0m, ReviewCount = 2200, Stock = 800, SoldCount = 6500, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1583863788434-e58a36330cf0?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[1].Id ?? "", CompanyId = insertedCompanies[1].Id ?? "", Name = "Webcam HD", Description = "1080p HD webcam", Price = 2499m, OriginalPrice = 3999m, DiscountPercentage = 38, CategoryId = electronicsCategory?.Id ?? "", SubCategoryId = electronicsAudio?.Id ?? "", IsFeatured = false, IsTrending = true, Rating = 4.3m, ReviewCount = 890, Stock = 250, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1587826080692-f439cd0b70da?w=500" } }
            });

            // Home & Living Products (5 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[2].Id ?? "", CompanyId = insertedCompanies[2].Id ?? "", Name = "Sofa Set", Description = "Comfortable 3-seater sofa", Price = 25000m, OriginalPrice = 35000m, DiscountPercentage = 29, CategoryId = homeCategory?.Id ?? "", SubCategoryId = homeFurniture?.Id ?? "", IsFeatured = true, IsTrending = false, Rating = 4.3m, ReviewCount = 750, Stock = 50, SoldCount = 450, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[2].Id ?? "", CompanyId = insertedCompanies[2].Id ?? "", Name = "Bed Sheet Set", Description = "Premium cotton bed sheets", Price = 1299m, OriginalPrice = 1999m, DiscountPercentage = 35, CategoryId = homeCategory?.Id ?? "", SubCategoryId = homeBedding?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 1200, Stock = 300, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[2].Id ?? "", CompanyId = insertedCompanies[2].Id ?? "", Name = "Curtains Set", Description = "Decorative window curtains", Price = 899m, OriginalPrice = 1499m, DiscountPercentage = 40, CategoryId = homeCategory?.Id ?? "", SubCategoryId = homeDecor?.Id ?? "", IsFeatured = false, IsTrending = false, Rating = 4.2m, ReviewCount = 560, Stock = 400, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[2].Id ?? "", CompanyId = insertedCompanies[2].Id ?? "", Name = "Dining Table", Description = "6-seater dining table", Price = 15000m, OriginalPrice = 22000m, DiscountPercentage = 32, CategoryId = homeCategory?.Id ?? "", SubCategoryId = homeFurniture?.Id ?? "", IsFeatured = true, IsTrending = false, Rating = 4.5m, ReviewCount = 340, Stock = 30, SoldCount = 280, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1617806118233-18e1de247200?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[2].Id ?? "", CompanyId = insertedCompanies[2].Id ?? "", Name = "Wall Decor Set", Description = "Modern wall art decor", Price = 1999m, OriginalPrice = 2999m, DiscountPercentage = 33, CategoryId = homeCategory?.Id ?? "", SubCategoryId = homeDecor?.Id ?? "", IsFeatured = false, IsTrending = true, Rating = 4.3m, ReviewCount = 780, Stock = 200, SoldCount = 1200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=500" } }
            });

            // Beauty Products (5 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[3].Id ?? "", CompanyId = insertedCompanies[3].Id ?? "", Name = "Lipstick Set", Description = "Premium lipstick collection", Price = 499m, OriginalPrice = 799m, DiscountPercentage = 38, CategoryId = beautyCategory?.Id ?? "", SubCategoryId = beautyMakeup?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 1100, Stock = 600, SoldCount = 3200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[3].Id ?? "", CompanyId = insertedCompanies[3].Id ?? "", Name = "Face Cream", Description = "Moisturizing face cream", Price = 399m, OriginalPrice = 699m, DiscountPercentage = 43, CategoryId = beautyCategory?.Id ?? "", SubCategoryId = beautySkincare?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 1800, Stock = 500, SoldCount = 4500, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[3].Id ?? "", CompanyId = insertedCompanies[3].Id ?? "", Name = "Eyeshadow Palette", Description = "Professional eyeshadow palette", Price = 799m, OriginalPrice = 1299m, DiscountPercentage = 38, CategoryId = beautyCategory?.Id ?? "", SubCategoryId = beautyMakeup?.Id ?? "", IsFeatured = false, IsTrending = true, Rating = 4.3m, ReviewCount = 890, Stock = 300, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[3].Id ?? "", CompanyId = insertedCompanies[3].Id ?? "", Name = "Hair Serum", Description = "Smoothing hair serum", Price = 349m, OriginalPrice = 599m, DiscountPercentage = 42, CategoryId = beautyCategory?.Id ?? "", SubCategoryId = beautyHaircare?.Id ?? "", IsFeatured = false, IsTrending = false, Rating = 4.2m, ReviewCount = 650, Stock = 400, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1526947425960-945c6e72858f?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[3].Id ?? "", CompanyId = insertedCompanies[3].Id ?? "", Name = "Foundation", Description = "Long-lasting foundation", Price = 599m, OriginalPrice = 999m, DiscountPercentage = 40, CategoryId = beautyCategory?.Id ?? "", SubCategoryId = beautyMakeup?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 1400, Stock = 450, SoldCount = 3800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1631214524020-7e18db9a8f92?w=500" } }
            });

            // Sports Products (5 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[4].Id ?? "", CompanyId = insertedCompanies[4].Id ?? "", Name = "Running Shoes", Description = "Professional running shoes", Price = 2999m, OriginalPrice = 4999m, DiscountPercentage = 40, CategoryId = sportsCategory?.Id ?? "", SubCategoryId = sportsFitness?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 1800, Stock = 400, SoldCount = 4200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[4].Id ?? "", CompanyId = insertedCompanies[4].Id ?? "", Name = "Yoga Mat", Description = "Non-slip yoga mat", Price = 599m, OriginalPrice = 999m, DiscountPercentage = 40, CategoryId = sportsCategory?.Id ?? "", SubCategoryId = sportsFitness?.Id ?? "", IsFeatured = true, IsTrending = true, Rating = 4.3m, ReviewCount = 1200, Stock = 500, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[4].Id ?? "", CompanyId = insertedCompanies[4].Id ?? "", Name = "Dumbbells Set", Description = "Adjustable dumbbells set", Price = 2999m, OriginalPrice = 4999m, DiscountPercentage = 40, CategoryId = sportsCategory?.Id ?? "", SubCategoryId = sportsFitness?.Id ?? "", IsFeatured = false, IsTrending = false, Rating = 4.4m, ReviewCount = 560, Stock = 150, SoldCount = 890, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[4].Id ?? "", CompanyId = insertedCompanies[4].Id ?? "", Name = "Sports Bag", Description = "Large sports duffel bag", Price = 899m, OriginalPrice = 1499m, DiscountPercentage = 40, CategoryId = sportsCategory?.Id ?? "", SubCategoryId = sportsFitness?.Id ?? "", IsFeatured = false, IsTrending = true, Rating = 4.2m, ReviewCount = 780, Stock = 300, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[4].Id ?? "", CompanyId = insertedCompanies[4].Id ?? "", Name = "Cricket Kit", Description = "Complete cricket kit", Price = 4999m, OriginalPrice = 7999m, DiscountPercentage = 38, CategoryId = sportsCategory?.Id ?? "", SubCategoryId = sportsFitness?.Id ?? "", IsFeatured = true, IsTrending = false, Rating = 4.6m, ReviewCount = 340, Stock = 80, SoldCount = 450, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=500" } }
            });

            // Books Products (4 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[5].Id ?? "", CompanyId = insertedCompanies[5].Id ?? "", Name = "Best Seller Novel", Description = "Top rated fiction novel", Price = 299m, OriginalPrice = 499m, DiscountPercentage = 40, CategoryId = booksCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.6m, ReviewCount = 2200, Stock = 500, SoldCount = 5600, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[5].Id ?? "", CompanyId = insertedCompanies[5].Id ?? "", Name = "Self Help Book", Description = "Motivational self help", Price = 349m, OriginalPrice = 599m, DiscountPercentage = 42, CategoryId = booksCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.4m, ReviewCount = 1800, Stock = 400, SoldCount = 4200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[5].Id ?? "", CompanyId = insertedCompanies[5].Id ?? "", Name = "Educational Book", Description = "Study guide for students", Price = 499m, OriginalPrice = 799m, DiscountPercentage = 38, CategoryId = booksCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = false, Rating = 4.3m, ReviewCount = 890, Stock = 300, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[5].Id ?? "", CompanyId = insertedCompanies[5].Id ?? "", Name = "Biography Book", Description = "Inspiring biography", Price = 399m, OriginalPrice = 699m, DiscountPercentage = 43, CategoryId = booksCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = false, Rating = 4.5m, ReviewCount = 1200, Stock = 350, SoldCount = 2800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1512820790803-83ca734da794?w=500" } }
            });

            // Jewelry Products (4 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[6].Id ?? "", CompanyId = insertedCompanies[6].Id ?? "", Name = "Gold Necklace", Description = "22K gold necklace", Price = 25000m, OriginalPrice = 35000m, DiscountPercentage = 29, CategoryId = jewelryCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.7m, ReviewCount = 450, Stock = 50, SoldCount = 340, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[6].Id ?? "", CompanyId = insertedCompanies[6].Id ?? "", Name = "Diamond Ring", Description = "Solitaire diamond ring", Price = 45000m, OriginalPrice = 65000m, DiscountPercentage = 31, CategoryId = jewelryCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = false, Rating = 4.8m, ReviewCount = 280, Stock = 20, SoldCount = 150, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[6].Id ?? "", CompanyId = insertedCompanies[6].Id ?? "", Name = "Silver Earrings", Description = "Sterling silver earrings", Price = 1499m, OriginalPrice = 2499m, DiscountPercentage = 40, CategoryId = jewelryCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.4m, ReviewCount = 890, Stock = 200, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[6].Id ?? "", CompanyId = insertedCompanies[6].Id ?? "", Name = "Fashion Bracelet", Description = "Trendy fashion bracelet", Price = 599m, OriginalPrice = 999m, DiscountPercentage = 40, CategoryId = jewelryCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.3m, ReviewCount = 1200, Stock = 400, SoldCount = 3200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=500" } }
            });

            // Footwear Products (4 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[7].Id ?? "", CompanyId = insertedCompanies[7].Id ?? "", Name = "Sports Shoes", Description = "High performance sports shoes", Price = 2499m, OriginalPrice = 3999m, DiscountPercentage = 38, CategoryId = footwearCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 1800, Stock = 300, SoldCount = 4200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[7].Id ?? "", CompanyId = insertedCompanies[7].Id ?? "", Name = "Formal Shoes", Description = "Leather formal shoes", Price = 1999m, OriginalPrice = 3499m, DiscountPercentage = 43, CategoryId = footwearCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = false, Rating = 4.4m, ReviewCount = 890, Stock = 200, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1449505278894-297fdb3edbc1?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[7].Id ?? "", CompanyId = insertedCompanies[7].Id ?? "", Name = "Casual Sandals", Description = "Comfortable casual sandals", Price = 799m, OriginalPrice = 1299m, DiscountPercentage = 38, CategoryId = footwearCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.2m, ReviewCount = 1200, Stock = 400, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1595341888016-a392ef81b7de?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[7].Id ?? "", CompanyId = insertedCompanies[7].Id ?? "", Name = "Flip Flops", Description = "Beach flip flops", Price = 399m, OriginalPrice = 699m, DiscountPercentage = 43, CategoryId = footwearCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.1m, ReviewCount = 780, Stock = 500, SoldCount = 2800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1631451095765-2c91616fc9e6?w=500" } }
            });

            // Kids Products (4 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[8].Id ?? "", CompanyId = insertedCompanies[8].Id ?? "", Name = "Kids T-Shirt", Description = "Cotton t-shirt for kids", Price = 299m, OriginalPrice = 499m, DiscountPercentage = 40, CategoryId = kidsCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.3m, ReviewCount = 1200, Stock = 400, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[8].Id ?? "", CompanyId = insertedCompanies[8].Id ?? "", Name = "Kids Dress", Description = "Party dress for girls", Price = 599m, OriginalPrice = 999m, DiscountPercentage = 40, CategoryId = kidsCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = false, Rating = 4.4m, ReviewCount = 890, Stock = 250, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[8].Id ?? "", CompanyId = insertedCompanies[8].Id ?? "", Name = "Kids Shoes", Description = "Comfortable shoes for kids", Price = 499m, OriginalPrice = 799m, DiscountPercentage = 38, CategoryId = kidsCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.2m, ReviewCount = 780, Stock = 300, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1551107696-a4b0c5a0d9a2?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[8].Id ?? "", CompanyId = insertedCompanies[8].Id ?? "", Name = "School Bag", Description = "School bag for kids", Price = 699m, OriginalPrice = 1199m, DiscountPercentage = 42, CategoryId = kidsCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 1500, Stock = 350, SoldCount = 4200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500" } }
            });

            // Kitchen Products (4 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[9].Id ?? "", CompanyId = insertedCompanies[9].Id ?? "", Name = "Non-Stick Cookware", Description = "Non-stick cookware set", Price = 2999m, OriginalPrice = 4999m, DiscountPercentage = 40, CategoryId = kitchenCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 890, Stock = 200, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[9].Id ?? "", CompanyId = insertedCompanies[9].Id ?? "", Name = "Dinner Set", Description = "Premium dinner set", Price = 1999m, OriginalPrice = 3499m, DiscountPercentage = 43, CategoryId = kitchenCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = false, Rating = 4.3m, ReviewCount = 670, Stock = 150, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1603199506016-5d54ebef7609?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[9].Id ?? "", CompanyId = insertedCompanies[9].Id ?? "", Name = "Kitchen Knife Set", Description = "Professional knife set", Price = 1499m, OriginalPrice = 2499m, DiscountPercentage = 40, CategoryId = kitchenCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.5m, ReviewCount = 560, Stock = 300, SoldCount = 1400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1593618998160-e34014e67546?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[9].Id ?? "", CompanyId = insertedCompanies[9].Id ?? "", Name = "Storage Containers", Description = "Food storage containers", Price = 799m, OriginalPrice = 1299m, DiscountPercentage = 38, CategoryId = kitchenCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = false, Rating = 4.2m, ReviewCount = 890, Stock = 400, SoldCount = 2300, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=500" } }
            });

            // Toys Products (4 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[13].Id ?? "", CompanyId = insertedCompanies[13].Id ?? "", Name = "Building Blocks", Description = "Educational building blocks", Price = 1499m, OriginalPrice = 2499m, DiscountPercentage = 40, CategoryId = toysCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.7m, ReviewCount = 1800, Stock = 300, SoldCount = 5200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[13].Id ?? "", CompanyId = insertedCompanies[13].Id ?? "", Name = "Remote Control Car", Description = "Fast remote control car", Price = 1999m, OriginalPrice = 3499m, DiscountPercentage = 43, CategoryId = toysCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 1200, Stock = 200, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1594787318286-3d835c1d207f?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[13].Id ?? "", CompanyId = insertedCompanies[13].Id ?? "", Name = "Board Game Set", Description = "Classic board games collection", Price = 999m, OriginalPrice = 1599m, DiscountPercentage = 38, CategoryId = toysCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = false, Rating = 4.4m, ReviewCount = 780, Stock = 250, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1610890716271-e2fe9e9a0c0d?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[13].Id ?? "", CompanyId = insertedCompanies[13].Id ?? "", Name = "Puzzle Set", Description = "Educational puzzle games", Price = 599m, OriginalPrice = 999m, DiscountPercentage = 40, CategoryId = toysCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.3m, ReviewCount = 650, Stock = 350, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1606307585776-427c3c614ed0?w=500" } }
            });

            // Watches Products (3 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[15].Id ?? "", CompanyId = insertedCompanies[15].Id ?? "", Name = "Analog Watch", Description = "Classic analog watch", Price = 3999m, OriginalPrice = 6999m, DiscountPercentage = 43, CategoryId = watchesCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.5m, ReviewCount = 890, Stock = 150, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[15].Id ?? "", CompanyId = insertedCompanies[15].Id ?? "", Name = "Digital Watch", Description = "Modern digital watch", Price = 1999m, OriginalPrice = 3499m, DiscountPercentage = 43, CategoryId = watchesCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.3m, ReviewCount = 1200, Stock = 250, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1522312346375-d1a52e2b99b3?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[15].Id ?? "", CompanyId = insertedCompanies[15].Id ?? "", Name = "Sports Watch", Description = "Waterproof sports watch", Price = 2499m, OriginalPrice = 4499m, DiscountPercentage = 44, CategoryId = watchesCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = false, Rating = 4.4m, ReviewCount = 780, Stock = 200, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500" } }
            });

            // Bags Products (3 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[16].Id ?? "", CompanyId = insertedCompanies[16].Id ?? "", Name = "Backpack", Description = "Travel backpack", Price = 1499m, OriginalPrice = 2499m, DiscountPercentage = 40, CategoryId = bagsCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 1200, Stock = 300, SoldCount = 3400, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[16].Id ?? "", CompanyId = insertedCompanies[16].Id ?? "", Name = "Handbag", Description = "Designer handbag", Price = 1999m, OriginalPrice = 3499m, DiscountPercentage = 43, CategoryId = bagsCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = false, Rating = 4.5m, ReviewCount = 890, Stock = 200, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[16].Id ?? "", CompanyId = insertedCompanies[16].Id ?? "", Name = "Travel Bag", Description = "Large travel bag", Price = 2499m, OriginalPrice = 4499m, DiscountPercentage = 44, CategoryId = bagsCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.3m, ReviewCount = 670, Stock = 150, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500" } }
            });

            // Accessories Products (3 products)
            products.AddRange(new List<Product>
            {
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[17].Id ?? "", CompanyId = insertedCompanies[17].Id ?? "", Name = "Sunglasses", Description = "UV protection sunglasses", Price = 999m, OriginalPrice = 1799m, DiscountPercentage = 44, CategoryId = accessoriesCategory?.Id ?? "", SubCategoryId = "", IsFeatured = true, IsTrending = true, Rating = 4.4m, ReviewCount = 1500, Stock = 400, SoldCount = 4200, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[17].Id ?? "", CompanyId = insertedCompanies[17].Id ?? "", Name = "Wallet", Description = "Leather wallet", Price = 599m, OriginalPrice = 999m, DiscountPercentage = 40, CategoryId = accessoriesCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = false, Rating = 4.2m, ReviewCount = 890, Stock = 300, SoldCount = 2100, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1627123424574-724758594e93?w=500" } },
                new Product { Id = MongoDB.Bson.ObjectId.GenerateNewId().ToString(), VendorId = insertedVendors[17].Id ?? "", CompanyId = insertedCompanies[17].Id ?? "", Name = "Belt", Description = "Genuine leather belt", Price = 499m, OriginalPrice = 899m, DiscountPercentage = 44, CategoryId = accessoriesCategory?.Id ?? "", SubCategoryId = "", IsFeatured = false, IsTrending = true, Rating = 4.3m, ReviewCount = 780, Stock = 350, SoldCount = 1800, ImageBase64 = new List<string> { "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500" } }
            });
        }
